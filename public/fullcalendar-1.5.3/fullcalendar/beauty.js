//полную версию см. fullcalendar.js
(function (m, ma) {
    function wb(a) {
        m.extend(true, Ya, a)
    }
    ...
    var lc = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"],
        ...
        dc = {
            ...
            h: function (a) {
                return a.getHours() //return a.getHours() % 12 || 12
            },
            hh: function (a) {
                return Pa(a.getHours()) //return Pa(a.getHours() % 12 || 12)
            },
            H: function (a) {
                return a.getHours()
            },
            ...
            MMM: function (a, b) {
                return b.monthNames[a.getMonth()] //изменил с monthNamesShort на полные
            },
            MMMM: function (a, b) {
    ...
    wb({
        ...
        allDayText: "день",
        firstHour: 6,
        slotMinutes: 30,   //TODO: наверное стоит сделать как в госте, по 12 минут на приём ... по дефолту пусть 30
